...
const routes: Routes = [
  ...
  {path:"aluno/boleto/:ra_aluno", component:ListaBoletoAlunoComponent},
  {path:"aluno/boleto/cadastro/:ra_aluno", component:CadastrarBoletoComponent},
  {path:"aluno/boleto/edicao/:codigo/:ra_aluno", component:EdicaoBoletoComponent}
];
